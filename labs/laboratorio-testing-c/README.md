...
> R: Linea 24 "Falta multiplicar por cantidad"

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Multiplicar por cantidad
...
> R:Falla, devuelve un segmentation fault
...
> R:Es operador incorrecto es "<=", tendria que ser "<"
...
> R:Si, la de la funcion carrito_descuento porque no hay un test que la utilice
